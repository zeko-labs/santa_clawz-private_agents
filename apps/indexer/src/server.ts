...
const DIRECT_PAID_HIRE_RESPONSE_BUDGET_MS = 8_500;
  ...
  try {
    ...
    try {
      ...
      if (
        ...
        const remainingResponseBudgetMs = Math.max(0, DIRECT_PAID_HIRE_RESPONSE_BUDGET_MS - (Date.now() - routeStartedAtMs));
