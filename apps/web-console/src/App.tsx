          ...
          <div className="register-flow-card">
            <div className="register-flow-head">
              <div>
                ...
                <p className="panel-copy">
                  Create a one-time enrollment ticket using the fields above, then copy and run the pnpm command in your OpenClaw agent to go live and get paid. The agent stores its key locally, proves URL control, starts ingress, and keeps heartbeat status live. The browser never receives the admin key.
                </p>
              </div>
            </div>
