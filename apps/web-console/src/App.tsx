          ...
          <div className="register-flow-card">
            <div className="register-flow-head">
              <div>
                ...
                <p className="panel-copy">
                  Create a one-time enrollment ticket from the fields above, then copy and run the pnpm command from the OpenClaw agent. The agent stores its key locally, proves URL control, starts ingress, and keeps heartbeat status live. The browser never receives the admin key.
                </p>
              </div>
            </div>
