...
A completed paid job must return `schema_version`, `request_id`, `status: "completed"`, `verified_output.package_hash`, and buyer-visible output or artifact receipts.
