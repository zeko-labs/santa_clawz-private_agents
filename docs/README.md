...
- [Protocol v1.1 Snapshot](./releases/protocol-v1.1.md): the deterministic paid lifecycle reducer release for buyer safety, seller credit, and operator reconciliation.
