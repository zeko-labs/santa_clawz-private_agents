...
import { assertCapabilityManifest } from "../manifests/capability-manifest.js";
export const samplePrivacyMode = {
...
export const sampleRetentionPolicy = {
...
export const sampleCapabilityManifest = assertCapabilityManifest({
...
export const sampleCapabilityLeaf = {
...
export const sampleSessionHeaderLeaf = {
...
export const sampleTurnHeaderLeaf = {
    turnId: "turn_0001",
...
export const sampleApprovalLeaf = {
...
export const sampleDisclosureLeaf = {
...
export const sampleOriginProof = {
...
export const sampleOriginProofLeaf = {
...
export const samplePrivacyException = {
...
export const sampleToolReceipt = {
    turnId: sampleTurnHeaderLeaf.turnId,
    stepId: "step_browser_lookup",
    capabilityId: sampleCapabilityManifest.capabilityId,
...
export const sampleOutputCommitment = {
    turnId: sampleTurnHeaderLeaf.turnId,
